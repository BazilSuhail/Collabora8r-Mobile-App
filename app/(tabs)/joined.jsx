...
const JoinedProjects = () => {
  ...
  return (
    <View className="flex-1 bg-gray-50">
      {/* Header */}
      <View className="bg-white border-b border-gray-100 px-5 py-4 shadow-sm">
          ...
          <View>
            <View className="flex-row items-center">
              ...
              <View className="ml-3">
                ...
                <Text className="text-sm text-gray-500 mt-1">Projects you're part of</Text>
              </View>
            </View>
          </View>
                ...
                <Link href={`/joinedProjects/${project._id}`}>
                  <View className="relative h-48">
                    ...
                    <Image 
                      ...
                      className="absolute inset-0 h-[150px] "
                    />
